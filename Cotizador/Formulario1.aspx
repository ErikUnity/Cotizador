...
<body>
    ...
    <li></li>
    <li></li>
    <li><div class="cuadro" style="text-align:right;"><asp:Image ID="Image5" CssClass="cuadro" runat="server" Height="94px" ImageUrl="~/imagenes/logo_codisa.jpeg" Width="275px" /></div></li> 
       </ul>
    </div>
